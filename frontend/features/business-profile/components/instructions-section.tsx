...
export function MessageInstructionsSection({ value, onChange }: MessageInstructionsSectionProps) {
  return (
    <SectionCard
      step="03"
      ...
      accent="sky"
      badge={<Badge variant="default" className="text-[10px] h-5 px-1.5">Important</Badge>}
    ...
    >
      <div className="space-y-3">
        ...
        />
        <InfoNote>
          Ces instructions guident l&apos;IA sur comment répondre aux messages privés.
          Soyez précis sur le ton, la langue et les comportements souhaités.
        </InfoNote>
      </div>
    </SectionCard>
  );
...
export function CommentInstructionsSection({ value, onChange }: CommentInstructionsSectionProps) {
  return (
    <SectionCard
      step="04"
    ...
    >
      <div className="space-y-3">
        ...
        />
        <InfoNote>
          Ces instructions s&apos;appliquent aux commentaires publics sur vos publications.
          Indiquez si l&apos;IA doit inviter en MP, mentionner des produits, etc.
        </InfoNote>
      </div>
    </SectionCard>
  );
